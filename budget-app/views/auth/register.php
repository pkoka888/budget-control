        ...
        <div class="card w-full max-w-md">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="/register">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" required class="form-input" placeholder="Vaše jméno">
                    </div>
            ...
            <div class="card-footer">
                <p class="text-center text-slate-gray-600">
                    Již máte účet? <a href="/login" class="text-google-blue-600 hover:text-google-blue-700 font-medium">Přihlaste se</a>
                </p>
            </div>
        </div>
    </div>
